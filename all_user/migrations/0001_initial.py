...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='AllUser',
            fields=[
                ('privileges', models.CharField(blank=True, db_column='PRIVILEGES', max_length=255, null=True)),
                ...
                ('class_name', models.CharField(blank=True, db_column='CLASS_NAME', max_length=255, null=True)),
