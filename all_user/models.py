...
class AllUser(models.Model):
    privileges = models.CharField('权限等级',db_column='PRIVILEGES', max_length=255, blank=True, null=True)  # Field name made lowercase.
    ...
    class_name = models.CharField('班级',db_column='CLASS_NAME', max_length=255, blank=True, null=True)  # Field name made lowercase.
    phone = models.CharField('电话',db_column='PHONE', max_length=255, blank=True, null=True)  # Field name made lowercase.
    ...
    password = models.CharField('密码',db_column='PASSWORD', max_length=255)  # Field name made lowercase.
